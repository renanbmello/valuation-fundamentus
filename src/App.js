  ...
  return (
    <ThemeProvider theme={darkTheme}>
      ...
      <Box display="flex" justifyContent="center" mt={2}>
        ...
        <WAAC valorDeFirma={valorDeFirma} dividaLiquida={dividaLiquida} valorDeMercado={valorDeMercado}  Re={Re} Rd={Rd} c={c}/>

        {/* <Gordon dividensPerStock = {valorAtual * (dividensYield * 100)} dividendsGrowth ={dividendsGrowth} finalWaac={finalWaac} /> */}
      {lpa && vpa && (
        <div>
